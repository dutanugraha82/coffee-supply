    ...
    <form action="/" method="POST">
      ...
      <div class="card-body">
        <div class="form-group">
          ...
          <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Enter Coffee Type" name="origin_coffee" id="origin_coffee">
          @error('origin_coffee')
        ...
        <div class="form-group">
          <label>Weight</label>
          <input type="text" class="form-control" id="exampleInputPassword1" placeholder="Enter Weight" name="weight" id="weight">
          @error('weight')
                <div class="alert alert-danger">{{ $message }}</div>
         @enderror
        </div>
        <div class="form-group">
         ...
         @enderror
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="exampleInputPassword1" placeholder="Enter Item Code" name="itemcode">
            @error('itemcode')
                <div class="alert alert-danger">{{ $message }}</div>
         @enderror
          </div>
